...
# Generated on: Wed Jun 19 14:56:44 IST 2024 (Wed Jun 19 09:26:44 UTC 2024)
...
set_log_file fv/vedic8bit/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/vedic8bit -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/cad/GENUS201/tools.lnx86"
set CDN_SYNTH_ROOT      "/cad/GENUS201/tools.lnx86"
set env(CW_DIR) "/cad/GENUS201/tools.lnx86/lib/chipware"
set CW_DIR      "/cad/GENUS201/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path /home/cad/digital/180nm/dig/lib/ -library -both
read_library -liberty -both /root/PranS/proj/MAC16/vedic8bit/lib/fast.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  vedic8bit.v
elaborate_design -golden -root {vedic8bit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/vedic8bit/fv_map.v.gz
elaborate_design -revised -root {vedic8bit}
...
#add_name_alias fv/vedic8bit/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/vedic8bit/rtl_to_fv_map.log
}
